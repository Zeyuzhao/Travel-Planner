  ...
  <div class="trip-shell">
    <aside class="sidebar">
      <header class="trip-header">
        ...
        <div class="trip-meta">
          <div><span>Depart</span><strong>SEA · SEP 15</strong></div>
          <span class="meta-arrow">→</span>
          <div><span>Return</span><strong>SEP 23 · SEA</strong></div>
        </div>
      </header>
      ...
      <div class="sidebar-content">
        <section class="panel active" id="itinerary" aria-labelledby="itinerary-heading">
          ...
          <div class="home-flight"><span>SEP 23</span><strong>KIX → SEA</strong><small>Head home, camera roll full.</small></div>
        </section>
        ...
        <section class="panel" id="proposal" aria-labelledby="proposal-heading" hidden>
          ...
          <div class="proposal-card">
            ...
            <div class="proposal-copy">
              <span class="recommendation">Our pick · September 19</span>
...
proposalMarker.bindPopup(`<div class="city-popup"><small>THE MOMENT</small><strong>Kamo River Delta</strong><span>Golden hour · Sep 19</span></div>`, {
  closeButton: false,
  offset: [0, -8],
});
